            ...
            <div class="container-fluid">
                <div class="navbar-header"> 
                    ...
                    <a style="color:white;" class="navbar-brand" href="index.php">AKOLA STORE</a>
                      ...
                      <form class="container " style="max-width:450px;margin:10px 0px 0px 150px;">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                      ...
                      <?php
                        ...
                        <li ><a href = "cart.php" id="nav_li"><span class = "glyphicon glyphicon-shopping-cart"></span> Cart </a></li>
